      ...
      yAxis: [
        {
          type: "category",
          inverse: true,
          data: ["youtube", "weibo", "directive", "goolge", "baidu"],
          // y轴的线
          axisLine: {
            show: false
          },
    ...
    let yearData = [
      {
        ...
        data: [  // 两个数组是因为有两条线
             ...
             [43, 39, 121, 334, 220, 350, 380]
          ]
      },
      {
        year: '2020',  // 年份
        data: [  // 两个数组是因为有两条线
             [123, 175, 112, 197, 121, 67, 98],
             [143, 131, 165, 123, 178, 21, 82],
             [128, 82, 64, 43, 60, 19, 34]
          ]
      }
     ];
